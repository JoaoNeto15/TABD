...
sql = "select  name, count(initial_point_proj) from taxi_stands, taxi_services where st_distance(proj_location,initial_point_proj) < 150 GROUP BY 1 ORDER BY 2 ASC LIMIT 5;"
