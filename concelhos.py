...
sql ="select st_astext(st_envelope(st_collect(st_simplify(proj_boundary,100,FALSE)))) from cont_aad_caop2018"
...
sql = "select st_astext(st_simplify(proj_boundary,100,False)) from cont_aad_caop2018"
cursor_psql.execute(sql)
results = cursor_psql.fetchall()
#print(results[0])
